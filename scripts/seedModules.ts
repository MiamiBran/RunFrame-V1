...
const Z_LAYER_MODULES = [
  { layer: "z", code: 0, name: "System Core", state: "locked" },
  { layer: "z", code: 1, name: "Identity Engine", state: "locked" },
  { layer: "z", code: 2, name: "Command Center", state: "wip" },
  { layer: "z", code: 3, name: "Relationship Engine (CRM)", state: "stub" },
  { layer: "z", code: 4, name: "Execution Logic", state: "built" },
  { layer: "z", code: 5, name: "Rhythm + System Sync", state: "partial" },
  { layer: "z", code: 6, name: "General Consequence 🪖", state: "stub" },
  { layer: "z", code: 7, name: "Context & Memory Engine", state: "stub" },
  { layer: "z", code: 8, name: "Template Repository", state: "locked" },
  { layer: "z", code: 9, name: "Buffer", state: "spare" },
  { layer: "z", code: 10, name: "Content Distribution Hub", state: "stub" },
]

const X_LAYER_MODULES = [
  { layer: "x", code: 0, name: "POS Core System", state: "draft" },
  { layer: "x", code: 1, name: "POS Dashboard", state: "built" },
  { layer: "x", code: 2, name: "Scaling Vault", state: "wip" },
  { layer: "x", code: 3, name: "PRD Index", state: "stub" },
  { layer: "x", code: 4, name: "Roadmap Index", state: "draft" },
  { layer: "x", code: 5, name: "Execution Vault", state: "queued" },
  { layer: "x", code: 6, name: "Task Vault", state: "stub" },
  { layer: "x", code: 7, name: "Review Index", state: "stub" },
  { layer: "x", code: 8, name: "Knowledge Hub", state: "active" },
  { layer: "x", code: 9, name: "Automation Logic", state: "planned" },
  { layer: "x", code: 10, name: "SSIG", state: "live" },
  { layer: "x", code: 11, name: "PapaBare", state: "live" },
  { layer: "x", code: 12, name: "RustRaptor", state: "bootstrap" },
  { layer: "x", code: 13, name: "The Repaired Republic", state: "bootstrap" },
  { layer: "x", code: 14, name: "The Art of Progress", state: "live" },
  { layer: "x", code: 15, name: "Brand Identity", state: "drift" },
  { layer: "x", code: 16, name: "Marketing Site", state: "locked" },
  { layer: "x", code: 17, name: "Content Strategy", state: "drift" },
  { layer: "x", code: 18, name: "Crypto Arbitrage Engine", state: "placeholder" },
]

const Y_LAYER_MODULES = [
  { layer: "y", code: 0, name: "HoS Life Core", state: "draft" },
  { layer: "y", code: 1, name: "HoS Dashboard", state: "built" },
  { layer: "y", code: 2, name: "HoS Scaling Vault", state: "wip" },
  { layer: "y", code: 3, name: "HoS PRD Index", state: "stub" },
  { layer: "y", code: 4, name: "HoS Roadmap Index", state: "draft" },
  { layer: "y", code: 5, name: "HoS Execution Vault", state: "restore" },
  { layer: "y", code: 6, name: "HoS Task Vault", state: "skeleton" },
  { layer: "y", code: 7, name: "HoS Review Index", state: "empty" },
  { layer: "y", code: 8, name: "HoS Asset Bank", state: "live" },
  { layer: "y", code: 9, name: "HoS Automation Logic", state: "blank" },
  { layer: "y", code: 10, name: "Career Launchpad", state: "live" },
  { layer: "y", code: 11, name: "Fitness", state: "live" },
  { layer: "y", code: 12, name: "Finance", state: "live" },
  { layer: "y", code: 13, name: "Mental Clarity", state: "wip" },
  { layer: "y", code: 14, name: "Sleep", state: "draft" },
  { layer: "y", code: 15, name: "Nutrition Mastery", state: "live" },
  { layer: "y", code: 16, name: "Style", state: "active" },
  { layer: "y", code: 17, name: "Creative Output", state: "active" },
  { layer: "y", code: 18, name: "Time Management", state: "wip" },
  { layer: "y", code: 90, name: "Tone & Voice Archive", state: "archive" },
]
