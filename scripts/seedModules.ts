...
const Z_LAYER_MODULES = [
  ...
  { id: "00000000-0000-4000-a000-000000000001", layer: "z", code: 1, name: "Identity Engine", state: "locked" },
  { id: "00000000-0000-4000-a000-000000000002", layer: "z", code: 2, name: "Command Center", state: "wip" },
  { id: "00000000-0000-4000-a000-000000000003", layer: "z", code: 3, name: "Relationship Engine (CRM)", state: "stub" },
  { id: "00000000-0000-4000-a000-000000000004", layer: "z", code: 4, name: "Execution Logic", state: "built" },
  { id: "00000000-0000-4000-a000-000000000005", layer: "z", code: 5, name: "Rhythm + System Sync", state: "partial" },
  { id: "00000000-0000-4000-a000-000000000006", layer: "z", code: 6, name: "General Consequence 🪖", state: "stub" },
  { id: "00000000-0000-4000-a000-000000000007", layer: "z", code: 7, name: "Context & Memory Engine", state: "stub" },
  { id: "00000000-0000-4000-a000-000000000008", layer: "z", code: 8, name: "Template Repository", state: "locked" },
  { id: "00000000-0000-4000-a000-000000000009", layer: "z", code: 9, name: "Buffer", state: "spare" },
  { id: "00000000-0000-4000-a000-000000000010", layer: "z", code: 10, name: "Content Distribution Hub", state: "stub" },
]

const X_LAYER_MODULES = [
  { id: "00000000-0000-4000-b000-000000000000", layer: "x", code: 0, name: "POS Core System", state: "draft" },
  { id: "00000000-0000-4000-b000-000000000001", layer: "x", code: 1, name: "POS Dashboard", state: "built" },
  { id: "00000000-0000-4000-b000-000000000002", layer: "x", code: 2, name: "Scaling Vault", state: "wip" },
  { id: "00000000-0000-4000-b000-000000000003", layer: "x", code: 3, name: "PRD Index", state: "stub" },
  { id: "00000000-0000-4000-b000-000000000004", layer: "x", code: 4, name: "Roadmap Index", state: "draft" },
  { id: "00000000-0000-4000-b000-000000000005", layer: "x", code: 5, name: "Execution Vault", state: "queued" },
  { id: "00000000-0000-4000-b000-000000000006", layer: "x", code: 6, name: "Task Vault", state: "stub" },
  { id: "00000000-0000-4000-b000-000000000007", layer: "x", code: 7, name: "Review Index", state: "stub" },
  { id: "00000000-0000-4000-b000-000000000008", layer: "x", code: 8, name: "Knowledge Hub", state: "active" },
  { id: "00000000-0000-4000-b000-000000000009", layer: "x", code: 9, name: "Automation Logic", state: "planned" },
  { id: "00000000-0000-4000-b000-000000000010", layer: "x", code: 10, name: "SSIG", state: "live" },
  { id: "00000000-0000-4000-b000-000000000011", layer: "x", code: 11, name: "PapaBare", state: "live" },
  { id: "00000000-0000-4000-b000-000000000012", layer: "x", code: 12, name: "RustRaptor", state: "bootstrap" },
  {
  ...
  { id: "00000000-0000-4000-b000-000000000014", layer: "x", code: 14, name: "The Art of Progress", state: "live" },
  { id: "00000000-0000-4000-b000-000000000015", layer: "x", code: 15, name: "Brand Identity", state: "drift" },
  { id: "00000000-0000-4000-b000-000000000016", layer: "x", code: 16, name: "Marketing Site", state: "locked" },
  { id: "00000000-0000-4000-b000-000000000017", layer: "x", code: 17, name: "Content Strategy", state: "drift" },
  {
...
const Y_LAYER_MODULES = [
  ...
  { id: "00000000-0000-4000-c000-000000000001", layer: "y", code: 1, name: "HoS Dashboard", state: "built" },
  { id: "00000000-0000-4000-c000-000000000002", layer: "y", code: 2, name: "HoS Scaling Vault", state: "wip" },
  { id: "00000000-0000-4000-c000-000000000003", layer: "y", code: 3, name: "HoS PRD Index", state: "stub" },
  { id: "00000000-0000-4000-c000-000000000004", layer: "y", code: 4, name: "HoS Roadmap Index", state: "draft" },
  { id: "00000000-0000-4000-c000-000000000005", layer: "y", code: 5, name: "HoS Execution Vault", state: "restore" },
  { id: "00000000-0000-4000-c000-000000000006", layer: "y", code: 6, name: "HoS Task Vault", state: "skeleton" },
  { id: "00000000-0000-4000-c000-000000000007", layer: "y", code: 7, name: "HoS Review Index", state: "empty" },
  { id: "00000000-0000-4000-c000-000000000008", layer: "y", code: 8, name: "HoS Asset Bank", state: "live" },
  { id: "00000000-0000-4000-c000-000000000009", layer: "y", code: 9, name: "HoS Automation Logic", state: "blank" },
  { id: "00000000-0000-4000-c000-000000000010", layer: "y", code: 10, name: "Career Launchpad", state: "live" },
  { id: "00000000-0000-4000-c000-000000000011", layer: "y", code: 11, name: "Fitness", state: "live" },
  { id: "00000000-0000-4000-c000-000000000012", layer: "y", code: 12, name: "Finance", state: "live" },
  { id: "00000000-0000-4000-c000-000000000013", layer: "y", code: 13, name: "Mental Clarity", state: "wip" },
  { id: "00000000-0000-4000-c000-000000000014", layer: "y", code: 14, name: "Sleep", state: "draft" },
  { id: "00000000-0000-4000-c000-000000000015", layer: "y", code: 15, name: "Nutrition Mastery", state: "live" },
  { id: "00000000-0000-4000-c000-000000000016", layer: "y", code: 16, name: "Style", state: "active" },
  { id: "00000000-0000-4000-c000-000000000017", layer: "y", code: 17, name: "Creative Output", state: "active" },
  { id: "00000000-0000-4000-c000-000000000018", layer: "y", code: 18, name: "Time Management", state: "wip" },
  { id: "00000000-0000-4000-c000-000000000090", layer: "y", code: 90, name: "Tone & Voice Archive", state: "archive" },
]
...
async function seedModules() {
  ...
  try {
    ...
    const { error: deleteError } = await supabase
      .from("modules")
      .delete()
      .neq("id", "11111111-1111-1111-1111-111111111111") // Use a dummy UUID that won't exist
